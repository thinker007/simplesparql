SimpleSPARQL allows queries to SPARQL endpoints in a very simple language similar to [MQL](http://www.freebase.com/view/en/documentation). The query language is designed specifically for python and uses python dictionaries in the same way as MQL.
